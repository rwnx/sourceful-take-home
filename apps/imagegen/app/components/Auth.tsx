...
function Auth() {
  ...
  const fullLogOut = () => {
    // HACK: for some reason logout doesn't fully work. 
    // HACK: because auth wasnt part of the brief, i'm not spending lots of time on it (and i'd want to use http-only cookies for a real app)
